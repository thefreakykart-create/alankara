        ...
        <div className="space-y-5 min-w-0">
          ...
          <section className="bg-white border border-zinc-200 rounded-lg p-5 space-y-4">
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-0.5">Shown on product cards and search results.</p>
            </div>
          ...
          <section className="bg-white border border-zinc-200 rounded-lg p-5 space-y-4">
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-0.5">Additional photos shown in the product slideshow.</p>
            </div>
        ...
        <aside className="space-y-5">
          ...
          <div className="bg-white border border-zinc-200 rounded-lg p-5 space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm font-medium text-zinc-900">{isActive ? "Active" : "Draft"}</p>
                  <p className="text-xs text-zinc-500 mt-0.5">{isActive ? "Visible on storefront" : "Hidden from customers"}</p>
                </div>
                <button
                  type="button"
                  onClick={() => setIsActive((v) => !v)}
                  className={cn(
                    "relative inline-flex h-6 w-11 flex-none items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1",
              ...
              <div className="flex items-center justify-between gap-4 pt-3 border-t border-zinc-100">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 mt-0.5">{isFeatured ? "Shown on homepage" : "Not on homepage"}</p>
                </div>
                <button
                  type="button"
                  onClick={() => setIsFeatured((v) => !v)}
                  className={cn(
                    "relative inline-flex h-6 w-11 flex-none items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-1",
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="brass, festive, handcrafted"
                  className={inputCls}
                />
              </div>
            </div>
          ...
          <div className="bg-white border border-zinc-200 rounded-lg p-5">
            <button
              ...
              disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-md transition-colors disabled:opacity-50"
            >
              {loading && <Loader2 className="w-4 h-4 animate-spin" />}
              {loading ? "Creating…" : "Create Product"}
            </button>
            <p className="text-[11px] text-zinc-400 text-center mt-2.5">
              {isActive ? "Product will be live immediately." : "Saved as draft — publish anytime."}
            </p>
          </div>
